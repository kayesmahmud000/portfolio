...
<div className=" py-2 md:py-10">
             <p className=" font-semibold text-sm md:text-2xl text-neutral-700 dark:text-white text-left "> Hi, my name is </p>
      <h2 className="bg-clip-text text-transparent md:text-center bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 text-2xl md:text-4xl lg:text-7xl font-sans relative z-20 font-bold tracking-tight">
...
<FaArrowRightLong />
       ...
       <div className=' flex  gap-5 justify-end items-center mt-5'>
                <div  className="text-white hover:text-red-600 transition-colors duration-300"><a href="https://www.facebook.com/mah.mud.473648" target='_blank'><FaFacebook size={20} ></FaFacebook></a></div>
                <div   className="text-white hover:text-red-600 transition-colors duration-300"><a href="https://github.com/kayesmahmud000" target='_blank'><FaGithub size={20} ></FaGithub></a></div>
                <div   className="text-white hover:text-red-600 transition-colors duration-300"><a href="https://www.instagram.com/kayes.error_404/" target='_blank'><FaInstagram size={20} ></FaInstagram></a></div>
                <div   className="text-white hover:text-red-600 transition-colors duration-300"><a href="https://www.linkedin.com/in/kayes-mah/" target='_blank'><FaLinkedin size={20} ></FaLinkedin></a> </div>
            </div>
    </div>
         </div>
